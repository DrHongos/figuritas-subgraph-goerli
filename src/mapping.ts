...
export function handleAlbumClaimed(event: AlbumClaimed): void {
  ...
  entity.albumAddress = event.params.albumAddress
  ...
  //
  // - contract.AlbumCollectionImplementation(...)
  // - contract.AlbumsImplementation(...)
  // - contract.claimAlbum(...)
  // - contract.createAlbum(...)
  // - contract.getAlbumAddress(...)
  // - contract.getAlbumsLength(...)
  // - contract.owner(...)
}
